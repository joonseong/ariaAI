...
export default function LikedArtworksScreen() {
  const router = useRouter();
  const { artworks, isLoading, isLoadingMore, error, load, loadMore } = useLikedArtworks();
  ...
  return (
    <SafeAreaView className="flex-1 bg-background" edges={['top', 'bottom']}>
      <View className="flex-row items-center border-b border-border px-4 py-3">
        ...
        <Text className="ml-4 text-lg font-semibold text-text-primary">좋아요한 작품</Text>
      </View>
